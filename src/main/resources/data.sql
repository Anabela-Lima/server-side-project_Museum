...
insert into STAFF (id, first_name, last_name, dob, address, salary) values (1, 'Krissie', 'Ianittello', '1989-03-21', '3049 Manley Street', '£20097.57');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (2, 'Beniamino', 'Hebner', '2000-09-26', '2 Del Mar Place', '£20260.01');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (3, 'Erica', 'Trevithick', '1994-08-14', '94 Mcguire Hill', '£18181.05');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (4, 'Cacilia', 'Frawley', '2008-09-30', '2717 Division Terrace', '£26135.22');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (5, 'Robbyn', 'Notley', '1998-04-24', '510 Swallow Trail', '£20872.34');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (6, 'Cross', 'Blaxley', '1990-02-05', '513 Meadow Vale Lane', '£20155.75');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (7, 'Marni', 'Keppin', '2004-04-07', '74 Glacier Hill Center', '£25236.71');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (8, 'Zahara', 'Copeland', '1998-06-19', '778 Killdeer Trail', '£21457.56');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (9, 'Lindy', 'Denslow', '2009-03-24', '5101 Oak Avenue', '£19835.94');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (10, 'Haze', 'Neilson', '1994-09-11', '7192 Cascade Center', '£26285.70');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (11, 'Reine', 'MacEvilly', '1998-09-27', '6410 Spohn Hill', '£22641.96');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (12, 'Tracie', 'Rayner', '2006-12-12', '080 Kings Street', '£20485.06');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (13, 'Jereme', 'Huyche', '1981-12-22', '8730 Susan Road', '£26784.90');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (14, 'Irv', 'O''Bruen', '1982-07-10', '262 Menomonie Drive', '£20361.22');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (15, 'Jolene', 'Saw', '1986-03-17', '85 Southridge Drive', '£24106.15');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (16, 'Tobe', 'Dendon', '1983-03-28', '83348 Westridge Alley', '£21760.77');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (17, 'Rina', 'Sharvill', '1987-09-30', '92 Kedzie Pass', '£23642.59');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (18, 'Saidee', 'Morrant', '1983-11-13', '22 Bay Circle', '£20182.52');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (19, 'Austina', 'Tofanini', '1998-03-16', '4159 Dovetail Place', '£22789.63');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (20, 'Dayle', 'Milliken', '1983-04-24', '626 Harper Circle', '£20392.23');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (21, 'Christoph', 'Lamplough', '1983-06-06', '8841 Pierstorff Place', '£25572.86');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (22, 'Lucais', 'Pattillo', '2007-07-10', '8139 Waxwing Alley', '£25769.84');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (23, 'Konrad', 'Bedrosian', '1981-07-03', '3589 Graedel Trail', '£26066.64');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (24, 'Odessa', 'Drieu', '1982-02-02', '28591 Union Crossing', '£21745.43');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (25, 'Jennie', 'Samwyse', '2004-03-19', '86 Bayside Drive', '£23685.64');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (26, 'Patrizia', 'Chazotte', '1981-04-10', '99497 Michigan Plaza', '£19553.98');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (27, 'Sharl', 'Howie', '2009-01-23', '924 Annamark Pass', '£18080.19');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (28, 'Corrine', 'Crummie', '2007-02-23', '0192 Green Ridge Road', '£24346.96');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (29, 'Humberto', 'Masterton', '1991-12-30', '64947 Fulton Terrace', '£20391.85');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (30, 'Carleton', 'Bownass', '2001-10-28', '755 Beilfuss Hill', '£23833.61');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (31, 'Fin', 'Merrigans', '1993-03-10', '6954 Shoshone Terrace', '£26131.08');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (32, 'Lloyd', 'Copyn', '2002-09-14', '0830 Scofield Street', '£22230.38');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (33, 'Brigit', 'Bellfield', '1997-01-15', '0 Stuart Court', '£21430.15');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (34, 'Sergei', 'MacCracken', '1999-02-25', '55 Elka Avenue', '£24461.24');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (35, 'Hally', 'Bambrugh', '2007-05-08', '7783 Esker Street', '£19794.54');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (36, 'Karlyn', 'Mathonnet', '2001-11-04', '92676 Shopko Trail', '£23304.95');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (37, 'Jeanine', 'Forgie', '2000-03-14', '71 Arrowood Parkway', '£18349.24');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (38, 'Elli', 'Harfoot', '1983-06-05', '907 Lukken Hill', '£18794.28');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (39, 'Lotti', 'Izkovicz', '2008-12-03', '1 Grover Lane', '£21599.33');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (40, 'Liliane', 'Teeney', '1995-11-19', '52 Calypso Park', '£18560.45');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (41, 'Lyssa', 'Wallage', '1995-11-30', '13 Comanche Lane', '£19419.04');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (42, 'Raleigh', 'Vinden', '1994-03-23', '6 Luster Road', '£21603.97');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (43, 'Nappie', 'Streetfield', '2005-06-28', '47 Dayton Circle', '£19351.16');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (44, 'Warner', 'Leamy', '1980-08-30', '700 Corry Trail', '£18543.99');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (45, 'Curran', 'Fall', '2001-12-28', '13 Mesta Point', '£22366.08');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (46, 'Peirce', 'Strachan', '1988-11-11', '0 8th Park', '£25700.03');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (47, 'Kym', 'Constanza', '1996-05-12', '71539 Grayhawk Place', '£23145.60');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (48, 'Shea', 'Skully', '2003-04-16', '5 Anhalt Drive', '£22599.82');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (49, 'Kelsy', 'Kiehnlt', '1982-11-26', '677 Pawling Point', '£24679.65');
insert into STAFF (id, first_name, last_name, dob, address, salary) values (50, 'Lavinie', 'Chell', '1982-12-18', '326 Morningstar Junction', '£22014.50');